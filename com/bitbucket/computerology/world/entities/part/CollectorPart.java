package com.bitbucket.computerology.world.entities.part;
...
public class CollectorPart extends Entity {
    ...
    public CollectorPart() {
        this.setSize(64);
        this.setTexture("resources/images/collectorpart.png");
    }
    ...
    public void draw(Graphics g) {
        ...
        if (this.spinner == null) {
            try {
                this.spinner = new Image("resources/images/spinner.png", false, Image.FILTER_LINEAR);
