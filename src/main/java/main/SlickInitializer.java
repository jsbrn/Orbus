...
public class SlickInitializer extends StateBasedGame {
    ...
    public static void main(String[] args) throws IOException {
        ...
        try {
            ...
            WINDOW_INSTANCE.setDisplayMode(Window.getScreenWidth(), Window.getScreenHeight(), false);
            ...
            WINDOW_INSTANCE.setFullscreen(true);
            // Need to check if platform supports window icons before setting (i.e. some Linux distros)
//            WINDOW_INSTANCE.setIcons(new String[]{"images/orbus_logo_16.png"
//            ,"images/orbus_logo_32.png",
//            "images/orbus_logo_64.png",
//            "images/orbus_logo.png"});
