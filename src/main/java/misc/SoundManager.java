...
public class SoundManager {
    ...
    public static void loadSounds() {
        try {
            ALL_SOUNDS.add(new Sound("sounds/shoot.ogg"));
            ALL_SOUNDS.add(new Sound("sounds/shoot.ogg"));
            ALL_SOUNDS.add(new Sound("sounds/powerup.ogg"));
            ALL_SOUNDS.add(new Sound("sounds/dying.ogg"));
            ALL_SOUNDS.add(new Sound("sounds/failure.ogg"));
            ALL_SOUNDS.add(new Sound("sounds/victory.ogg"));
            ALL_SOUNDS.add(new Sound("sounds/teleport.ogg"));
            ALL_SOUNDS.add(new Sound("sounds/forcefield_spawn.ogg"));
            ALL_SOUNDS.add(new Sound("sounds/forcefield_ambient.ogg"));
