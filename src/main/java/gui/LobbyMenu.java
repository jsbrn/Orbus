...
import network.Packet.PlayerNameChange;
import network.Packet.RemovePlayer;
import network.Packet.TeamToggle;
...
public class LobbyMenu extends BasicGameState {
    ...
    public void init(GameContainer gc, StateBasedGame sbg) throws SlickException {
        ...
        state = sbg;
        kick = new Image("images/kick.png", false, Image.FILTER_LINEAR);
        add_bot_buttons = new Button[]{
        new Button("Add Red Bot"),
        new Button("Add Blue Bot"),
        new Button("Add Green Bot"),
        new Button("Add Purple Bot")};
        lobbyheader = new Image("images/lobbyheader.png", false, Image.FILTER_NEAREST);
    }
