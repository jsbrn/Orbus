...
import com.bitbucket.computerology.world.entities.deployables.GravBomb;
import com.bitbucket.computerology.world.entities.deployables.Sidekick;
...
public class Orb extends Entity {
    ...
    public Orb() {
        this.setSize(8);
        this.setTexture("resources/images/orb.png");
    }
