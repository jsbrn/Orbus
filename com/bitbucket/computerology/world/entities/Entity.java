...
import com.bitbucket.computerology.network.Packet.AddEntity;
import com.bitbucket.computerology.network.Packet.AddForce;
import com.bitbucket.computerology.network.Packet.RemoveForce;
...
import com.bitbucket.computerology.network.Packet.UpdatePlayerCard;
...
import com.bitbucket.computerology.world.entities.deployables.*;
...
public class Entity {
    ...
    public void draw(Graphics g) {
        if (RANGE_INDICATORS == null) {
            ...
            try {
                RANGE_INDICATORS[0] = new Image("resources/images/redrange.png");
                RANGE_INDICATORS[1] = new Image("resources/images/bluerange.png");
                RANGE_INDICATORS[2] = new Image("resources/images/greenrange.png");
                RANGE_INDICATORS[3] = new Image("resources/images/purplerange.png");
        ...
        if (texture == null) { 
            try { 
                texture = new Image("resources/images/orb.png");
                orb = new Image("resources/images/orb.png", false, Image.FILTER_LINEAR);
                part = new Image("resources/images/collectorpart.png", false, Image.FILTER_LINEAR);
            } catch (SlickException ex) {
                Logger.getLogger(Entity.class.getName()).log(Level.SEVERE, null, ex);
            }
        } 
    ...
    public void addEnergy(double e) {
        ...
        if ((int)Math.abs(energy-energy_at_last_packet) >= 0.9 && GameScreen.YOU.isHost()) {
            ...
            //send packet
            Packet.UpdateEntity u = new Packet.UpdateEntity();
            u.id = this.getID();
            u.energy = energy+e;
            u.orb = this instanceof Orb;
            u.orbs = orbs;
