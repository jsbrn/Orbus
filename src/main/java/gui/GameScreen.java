...
public class GameScreen extends BasicGameState {
    ...
    public void init(GameContainer gc, StateBasedGame sbg) throws SlickException {
        ...
        help = new Image("images/help.png", false, Image.FILTER_LINEAR);
        victory_progress = new Image("images/progress.png", false, Image.FILTER_LINEAR);
        partpanelside = new Image("images/partpanelside.png", false, Image.FILTER_LINEAR);
        partpaneltop = new Image("images/partpaneltop.png", false, Image.FILTER_LINEAR);
        circuit = new Image("images/circuit.png", false, Image.FILTER_LINEAR);
        hud = new Image("images/playerhud.png", false, Image.FILTER_LINEAR);
        tip_orbs = new Image("images/tip_orbs.png", false, Image.FILTER_LINEAR);
        tip_circuits = new Image("images/tip_circuits.png", false, Image.FILTER_LINEAR);
